...
import net.appitiza.moderno.ui.activities.adapter.UserCheckInSiteAdapter
...
class UserReportActivity : BaseActivity(),UserSiteClick {
    ...
    private lateinit var ciadapter: UserCheckInSiteAdapter
    private lateinit var coadapter: UserCheckInSiteAdapter
