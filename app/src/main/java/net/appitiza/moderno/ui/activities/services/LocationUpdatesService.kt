...
class LocationUpdatesService : Service() {
    ...
    private val PACKAGE_NAME = "net.appitiza.android.lifedrop.ui.activities.locationupdatesforegroundservice"
    ...
    override fun onUnbind(intent: Intent): Boolean {
        ...
        if (!mChangingConfiguration && Utils.requestingLocationUpdates(this)) {
            ...
            /*
            // @string/app_name(developer). If targeting O, use the following code.
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.O) {
    ...
    private fun getNotification(): Notification {
        ...
        val activityPendingIntent = PendingIntent.getActivity(this, 0,
                Intent(this, AdminActivity::class.java), 0)

        val builder = NotificationCompat.Builder(this, "L_CHANNEL_ID")
